...
#define VERA_MIDLINE_DATA_STEP_8BPP (1 * VERA_MIDLINE_X_SCALE)
#define VERA_MIDLINE_DATA_STEP_4BPP (1 * VERA_MIDLINE_X_SCALE)
#define VERA_MIDLINE_LAYER_STEP (9 * VERA_MIDLINE_X_SCALE)
#define VERA_MIDLINE_DC_STEP (12 * VERA_MIDLINE_X_SCALE)
#define VERA_MIDLINE_FX_STEP (1 * VERA_MIDLINE_X_SCALE)
